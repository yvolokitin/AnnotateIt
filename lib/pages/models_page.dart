...
class _ModelPageState extends State<ModelPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<ModelInfo> models = [
      ...
      ModelInfo(
        id: 'classification_efficientnet-tflite-lite0-int8-v2',
        title: 'Classification EfficientNet TFLite',
        description: "TensorFlow Lite EfficientNet Classification EfficientNet is a family of convolutional neural networks (CNNs) that achieve state-of-the-art accuracy with fewer parameters and lower computational cost compared to traditional models. When converted to TensorFlow Lite (TFLite), EfficientNet becomes optimized for mobile and edge devices, enabling real-time image classification with minimal latency and power consumption.",
        imageAsset: 'assets/images/ssd_mobilenet.jpg',
        urlEncoder: 'https://github.com/yvolokitin/segment-anything-onnx-models/releases/download/SAM2_Hiera_Large/classification_efficientnet-tflite-lite0-int8-v2.tflite',
        urlDecoder: '',
        ...
        shaEncoder: 'aa03e4017f54fd5c743bd397b0a3e136fab0942f9c7cd715064a31ca3e4fc996',
        shaDecoder: '',
