...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get aboutTitle => 'À propos d\'AnnotateIt';

  @override
  String get aboutDescription =>
      'AnnotateIt est une application d\'annotation conçue pour simplifier le processus d\'annotation pour les projets de vision par ordinateur. Que vous travailliez sur la classification d\'images, la détection d\'objets, la segmentation ou d\'autres tâches de vision, AnnotateIt offre la flexibilité et la précision nécessaires pour un étiquetage de données de haute qualité.';
  ...
  @override
  String get betaDialogTitle => 'Modèles de segmentation (Preview)';

  @override
  String get betaDialogMessage =>
      'Pourquoi SAM Mobile, SAM2 Hiera Base+ et SAM2 Hiera Large donnent-ils souvent des résultats similaires?\n\nCompilations non Web (Windows/macOS/Linux/Android/iOS) : l\'inférence SAM réelle n\'est pas encore activée. L\'application a recours à une heuristique basée sur le contenu (croissance de région avec graine + extraction de contours). Changer de modèle ne modifie pas cette heuristique, donc les résultats sont similaires.\n\nCompilations Web : une véritable inférence ONNX est utilisée lorsque le modèle se charge correctement, mais les résultats sont toujours post-traités de la même manière : masque du décodeur en 256×256 → seuillage (Otsu), filtrage du composant connecté au clic, comblement des trous, lissage et simplification du polygone. Cela peut supprimer des détails fins et rapprocher les modèles plus que prévu.\n\nLimites connues dans cette préversion :\n • Indications à un seul point uniquement (pas de boîtes/indices multi-points).\n • L\'image est prétraitée à 1024 px et le masque du décodeur est 256×256 → perte de détails sur les petits objets/bords.\n • Le seuillage/le lissage peut sur- ou sous-segmenter selon le contraste/le bruit de l\'image.\n • Sur les plateformes non Web, le changement de modèle affecte surtout les libellés/l\'UI, pas le backend réel de segmentation.';

  @override
  String get betaDialogTips =>
      'Conseils pour améliorer les résultats dès maintenant :\n • Zoomez et cliquez bien à l\'intérieur de l\'objet d\'intérêt.\n • Privilégiez des images avec un bon contraste local et peu d\'artefacts de compression.\n • Si possible, essayez la version Web pour une inférence SAM réelle.\n • Affinez manuellement les contours après l\'auto-segmentation si nécessaire.';
  ...
  @override
  String get deleteAllAnnotations => 'Supprimer toutes les annotations';

  @override
  String get deleteAllAnnotationsConfirm =>
      'Êtes-vous sûr de vouloir supprimer toutes les annotations pour cette image ?\nCette action est irréversible.';
  ...
  @override
  String get labelEditMoveUp => 'Haut';

  @override
  String get labelEditMoveDown => 'Bas';

  @override
  String get labelEditDefault => 'Défaut';

  @override
  String get labelEditUndefault => 'SansDéfaut';
  ...
  @override
  String get ffmpegStep1Title => 'Étape 1 : Vérifier FFmpeg';

  @override
  String get ffmpegDescription =>
      'FFmpeg est une suite gratuite et open source pour traiter la vidéo et l’audio. AnnotateIt utilise FFmpeg sous Windows pour extraire des images individuelles de votre vidéo à des fins d’annotation.';

  @override
  String get ffmpegWebsite => 'Site web de FFmpeg';

  @override
  String get ffmpegWindowsBuilds => 'Versions Windows';

  @override
  String get ffmpegTip =>
      'Astuce : Après l’installation, ajoutez ffmpeg.exe à votre PATH ou cliquez sur \"Sélectionner FFmpeg\" pour choisir l’exécutable.';

  @override
  String ffmpegUsingPath(Object path) {
    return 'Utilisation : $path';
  }

  @override
  String get ffmpegUnavailable =>
      'FFmpeg non disponible. Sélectionnez d’abord ffmpeg.exe.';

  @override
  String get ffmpegSelectButton => 'Sélectionner FFmpeg';

  @override
  String get ffmpegRecheckButton => 'Vérifier à nouveau';

  @override
  String get videoStep2Title => 'Étape 2 : Sélectionner le fichier vidéo';

  @override
  String get videoStep2Text =>
      'Une fois FFmpeg disponible, cliquez sur Continuer pour choisir une vidéo à importer.';

  @override
  String get mobileFramesInfo =>
      'Les images seront extraites avec les capacités intégrées de votre appareil (FFmpeg non requis).';

  @override
  String get mobileTapContinueInfo =>
      'Touchez Continuer pour choisir un fichier vidéo à importer et extraire les images en tant qu’images.';

  @override
  String get importNotCompletedTitle => 'Importation non terminée';

  @override
  String importNotCompletedDiagnostics(Object diag) {
    return 'Impossible d’extraire les images de la vidéo sélectionnée.\n\nDiagnostic :\n$diag';
  }

  @override
  String get uploadStopped => 'Téléchargement arrêté';

  @override
  String get importCompleteTitle => 'Importation terminée';

  @override
  String get importCompleteExtractedPrefix => 'Extraits';

  @override
  String get importCompleteFrame => 'image';

  @override
  String get importCompleteFrames => 'images';

  @override
  String get importCompleteAndAdded => 'et ajoutés au jeu de données.';
  ...
  String get cameraLinuxUnsupported =>
      'La fonctionnalité de caméra n’est pas prise en charge sous Linux';

  @override
  String videoToFramesFailed(Object error) {
    return 'Échec de la conversion de la vidéo en images : $error';
  }

  @override
  String get selectFfmpegDialogTitle => 'Sélectionner l’exécutable ffmpeg';

  @override
  String get preLabelIntroTflite =>
      'Analyser automatiquement les images du projet à l’aide d’un modèle TensorFlow Lite et proposer des noms d’étiquettes. Vous pourrez les revoir et les modifier avant l’enregistrement.';

  @override
  String get preLabelIntroMlkit =>
      'Analyser automatiquement les images du projet à l’aide de Google ML Kit et proposer des noms d’étiquettes. Vous pourrez les revoir et les modifier avant l’enregistrement.';

  @override
  String get preLabelErrorReadDatasetsTryAgain =>
      'Échec de la lecture des jeux de données. Veuillez réessayer.';

  @override
  String get preLabelErrorCheckModelAvailability =>
      'Échec de la vérification de la disponibilité du modèle.';

  @override
  String preLabelProcessedOfTotalImages(Object processed, Object total) {
    return 'Traitement de $processed sur $total images';
  }

  @override
  String get preLabelNoImagesUploadFirst =>
      'Aucune image trouvée dans les jeux de données du projet. Veuillez d’abord importer des médias.';

  @override
  String get preLabelNoLabelsSuggested =>
      'Aucune étiquette n’a été proposée. Vous pouvez fermer cette boîte de dialogue.';

  @override
  String get preLabelStep1Title => 'Étape 1 : Vérifier les prérequis';

  @override
  String get preLabelCheckingProjectAndModels =>
      'Vérification du projet et des modèles...';

  @override
  String preLabelImagesInProjectDatasets(Object count) {
    return 'Images dans les jeux de données du projet : $count';
  }

  @override
  String get preLabelModelAvailableInFolder =>
      'Modèle disponible dans votre dossier Models';

  @override
  String get preLabelModelMissingPleaseDownload =>
      'Modèle manquant. Veuillez le télécharger d’abord.';

  @override
  String get preLabelRecheck => 'Vérifier à nouveau';

  @override
  String get preLabelAllPrerequisitesMet => 'Tous les prérequis sont remplis';
  ...
  @override
  String get preLabelBackendTfliteDetection => 'Backend : TFLite Détection';
  ...
  String get preLabelYouCanProceed =>
      'Vous pouvez procéder à la pré‑annotation lorsque vous êtes prêt.';

  @override
  String get preLabelStartPreLabeling => 'Démarrer la pré‑annotation';

  @override
  String get preLabelStep0Title => 'Étape 0 : Ce qui va se passer ensuite';

  @override
  String get preLabelBulletScanTflite =>
      '• Les images du projet seront analysées avec votre modèle TensorFlow Lite.';

  @override
  String get preLabelBulletScanMlkit =>
      '• Les images du projet seront analysées avec Google ML Kit sur cet appareil.';

  @override
  String get preLabelBulletProposeLabels =>
      '• Nous proposerons des noms d’étiquettes trouvés dans les images. Vous pourrez les revoir et les modifier.';

  @override
  String get preLabelBulletStartPreAnnotationSavesLabels =>
      '• En cliquant sur \"Démarrer la pré‑annotation\", les étiquettes seront enregistrées dans le projet.';

  @override
  String get preLabelBulletThenAutoAnnotateDetection =>
      '• Les images seront ensuite annotées automatiquement avec des boîtes englobantes pour les étiquettes détectées.';

  @override
  String get preLabelBulletThenAutoAnnotateClassification =>
      '• Les images seront ensuite annotées automatiquement avec des étiquettes de classification.';

  @override
  String get preLabelBulletRespectExisting =>
      '• Les annotations existantes sont respectées et les doublons sont évités.';

  @override
  String get preLabelBulletCancelAnyTime =>
      '• Vous pouvez annuler à tout moment. Sur les grands projets, le traitement peut prendre du temps.';
  ...
  @override
  String get preLabelScanningImages => 'Analyse des images...';

  @override
  String get preLabelErrorReadDatasets =>
      'Échec de la lecture des jeux de données.';

  @override
  String get preLabelErrorDetectionModelMissing =>
      'Modèle de détection introuvable dans votre dossier Models. Veuillez le télécharger depuis l’écran Modèles.';

  @override
  String get preLabelErrorClassificationModelMissing =>
      'Modèle de classification introuvable dans votre dossier Models. Veuillez le télécharger depuis l’écran Modèles.';

  @override
  String preLabelErrorInitBackendWithDetails(Object details) {
    return 'Échec de l’initialisation du backend d’étiquetage. Vérifiez les fichiers du modèle ou les autorisations.\n\nDétails : $details';
  }

  @override
  String get preLabelSavingLabels => 'Enregistrement des étiquettes...';

  @override
  String get preLabelErrorSaveLabelsOrAnnotate =>
      'Échec de l’enregistrement des étiquettes ou de l’annotation des images';

  @override
  String get preLabelAnnotatingImages => 'Annotation des images...';
